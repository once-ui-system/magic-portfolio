export const skillRatings = {
  categories: {
    ...
    "Version Control and Collaboration Tools": ["Git", "GitHub", "GitLab", "Slack", "Jira", "Trello", "Microsoft Teams", "Code Collaboration"],
  },
  ratings: {
    HTML: 8,
    CSS: 7,
    ...
    "SAFe Scrum Master Role": 5, 
    "Flow Metrics (SAFe 6.0)": 5, 
    "Team Syncs & Stand-Ups": 7,
    "Conflict Resolution": 8, 
    "Facilitating Agile Ceremonies": 7, 
    "Kanban": 7, 
    "CI/CD Pipelines": 6, 
    "CALMR Approach": 4,
