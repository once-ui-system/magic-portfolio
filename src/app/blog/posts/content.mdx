...
Your personal details are used across the whole app to render personalised headings, labels and images. Languages are displayed on the `/about` page, and location and time in the header.
