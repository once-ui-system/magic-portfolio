...
summary: "Learn how to use custom components in markdown with Magic Portfolio, including Once UI components and custom imports."
tag: "Magic Portfolio"
---
...
The code block component works based on Once UI's CodeBlock. You can access it with the complete syntax for full customisation, or by using the standard markdown syntax (triple backticks) with pre-configured props.
...
Media provides an optimised way to display images. Access it with the `Media` component for full customisation or use the markdown syntax.
...
SmartLink provides an enhanced way to link to internal and external resources. You can access it with the `SmartLink` component for full customisation or with the standard markdown syntax.
