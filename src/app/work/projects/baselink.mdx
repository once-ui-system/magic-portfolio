...
images:
  - "/images/projects/baselink/cover0.png"
...
A highlight for me was collaborating with  **Matthew Bergamini** again. He handled the backend with precision, from parsing webhook payloads to implementing secure API routes. It was a huge relief knowing I could trust the data structure and focus fully on rendering it meaningfully. We synced regularly to iron out bugs and ensure frontend/backend alignment.
...
This project is the project assignment for subject **CSIT321: Project** (Final Year Capstone), run by the **University of Wollongong, Australia**, luckily I have worked with **Devika** - a software company based in Wollongong.
